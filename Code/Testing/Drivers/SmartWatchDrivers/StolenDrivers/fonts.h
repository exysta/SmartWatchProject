...
extern const uint16_t* weather_gif_array[19];

extern const int heart_gif_array_LEN;
extern const int heart_gif_frame_pixel_count;
extern const uint16_t* heart_gif_array[14];
